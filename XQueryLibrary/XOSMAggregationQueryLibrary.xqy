...
declare function xosm_ag:metricDistance($document as node()*, $street as node())
{
  ...
  let $distance := geo:distance(xosm_gml:_osm2GmlLine($each),xosm_gml:_osm2GmlLine($street)),
...
declare function xosm_ag:bottomCountDistance($document as node()*,$street as node(), 
$k as xs:integer)
{
 let $list := xosm_ag:metricDistance($document,$street)
 return
...
declare function xosm_ag:topCountDistance($document as node()*, $street as node(),
$k as xs:integer)
{
 let $list := xosm_ag:metricDistance($document,$street)
 return
